...
<template>
    <AppLayout title="Nuovo template verbale">
        <Head title="Nuovo template verbale" />
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Nuovo template verbale</h2>
        ...
        <div class="py-6 max-w-3xl mx-auto sm:px-6">
            <form @submit.prevent="form.post(route('verbale-templates.store'))" class="space-y-4 bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <div>
