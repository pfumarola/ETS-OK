...
<template>
    <AppLayout title="Nuovo template documento">
        <Head title="Nuovo template documento" />
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Nuovo template documento</h2>
        ...
        <div class="py-6 max-w-3xl mx-auto sm:px-6">
            <form @submit.prevent="form.post(route('document-templates.store'))" class="space-y-4 bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <div>
