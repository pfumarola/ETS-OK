...
<template>
    <AppLayout title="Nuovo articolo">
        <Head title="Nuovo articolo" />
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Nuovo articolo</h2>
        ...
        <div class="py-6 max-w-2xl mx-auto sm:px-6">
            <form @submit.prevent="form.post(route('items.store'))" class="space-y-4 bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <div>
                ...
                <div class="flex gap-2">
                    <PrimaryButton type="submit" :disabled="form.processing"><PlusIcon class="size-4 me-2" aria-hidden="true" />Crea articolo</PrimaryButton>
