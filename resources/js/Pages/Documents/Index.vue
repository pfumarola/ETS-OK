        ...
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                    <Link :href="route('document-templates.index')" class="inline-flex items-center gap-1 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300 text-sm">Template documenti</Link>
