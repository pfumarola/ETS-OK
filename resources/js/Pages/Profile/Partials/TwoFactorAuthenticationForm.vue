...
<template>
    <ActionSection>
        ...
        <template #description>
            Aggiungi ulteriore sicurezza al tuo account con l'autenticazione a due fattori.
        </template>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                <p>
                    Quando l'autenticazione a due fattori è attiva, ti verrà richiesto un codice sicuro durante l'accesso. Puoi ottenere il codice dall'app Google Authenticator sul tuo smartphone.
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p v-if="confirming" class="font-semibold">
                            Per completare l'attivazione, scansiona il codice QR con l'app autenticatore del telefono oppure inserisci la chiave di configurazione e il codice OTP generato.
                        </p>

                        <p v-else>
                            L'autenticazione a due fattori è attiva. Scansiona il codice QR con l'app autenticatore oppure inserisci la chiave di configurazione.
                        </p>
                    </div>
                    ...
                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            Chiave di configurazione: <span v-html="setupKey"></span>
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
                        <p class="font-semibold">
                            Conserva questi codici di recupero in un gestore di password sicuro. Servono a recuperare l'accesso all'account se perdi il dispositivo per l'autenticazione a due fattori.
                        </p>
                    </div>
