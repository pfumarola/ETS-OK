...
<template>
    <ActionSection>
        ...
        <template #description>
            Gestisci ed esci dalle sessioni attive su altri browser e dispositivi.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Se necessario, puoi uscire da tutte le altre sessioni su tutti i tuoi dispositivi. Di seguito sono elencate alcune sessioni recenti; l'elenco potrebbe non essere completo. Se ritieni che il tuo account sia stato compromesso, dovresti anche aggiornare la password.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Inserisci la password per confermare che desideri uscire dalle altre sessioni su tutti i dispositivi.
