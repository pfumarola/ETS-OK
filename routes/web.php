...
use App\Http\Controllers\ConvocazioneController;
...
Route::middleware([
    ...
    Route::get('convocazioni', [ConvocazioneController::class, 'index'])->name('convocazioni.index');
    Route::get('convocazioni/create', [ConvocazioneController::class, 'create'])->name('convocazioni.create');
    Route::post('convocazioni', [ConvocazioneController::class, 'store'])->name('convocazioni.store');
    Route::get('convocazioni/{convocazione}', [ConvocazioneController::class, 'show'])->name('convocazioni.show');
    Route::get('convocazioni/{convocazione}/edit', [ConvocazioneController::class, 'edit'])->name('convocazioni.edit');
    Route::put('convocazioni/{convocazione}', [ConvocazioneController::class, 'update'])->name('convocazioni.update');
    Route::post('convocazioni/{convocazione}/send', [ConvocazioneController::class, 'send'])->middleware('throttle:10,1')->name('convocazioni.send');
    Route::get('convocazioni/{convocazione}/pdf', [ConvocazioneController::class, 'downloadPdf'])->name('convocazioni.pdf');
